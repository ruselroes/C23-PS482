...
import com.project.capstoneapp.ui.camera.ScanCameraActivity
...
class BottomMainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        binding.btnScan.setOnClickListener {
            val iScan = Intent(this, ScanCameraActivity::class.java)
            startActivity(iScan)
        }
    }
    ...
    override fun onBackPressed() {
        ...
        btnYes?.setOnClickListener {
            val iLanding = Intent(this, LandingActivity::class.java)
            finishAffinity()
